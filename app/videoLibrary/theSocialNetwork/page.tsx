...
// const TheSocialNetwork = (): JSX.Element => {
...
//     const [simpleCaptions, setSimpleCaptions] = useState<boolean>(false);
...
//         if (video) {
//             const tracks = video.textTracks;
//             let defaultTrack: TextTrack | undefined;
//             let simplifiedTrack: TextTrack | undefined;

//             for (let i = 0; i < tracks.length; i++) {
//                 if (tracks[i].label === "Default English") {
//                     defaultTrack = tracks[i];
//                 }
//                 if (tracks[i].label === "Simplified English") {
//                     simplifiedTrack = tracks[i];
//                 }
//             }

//             if (!defaultTrack || !simplifiedTrack) return;

//             if (!simpleCaptions) {
//                 defaultTrack.mode = "hidden";
//                 simplifiedTrack.mode = "showing";
//             } else {
//                 defaultTrack.mode = "showing";
//                 simplifiedTrack.mode = "hidden";
//             }
//             setSimpleCaptions(!simpleCaptions);
//         }
//     };
...
//                         <track label="Default English" kind="subtitles" srcLang="en" src={"/theSocialNetwork/theSocialNetwork.vtt"} />
//                         <track label="Simplified English" kind="subtitles" srcLang="en" src={"/theSocialNetwork/theSocialNetwork_simplified.vtt"} />
//                     </Video>
//                 )}
//                 <audio id="voice" ref={voiceRef} src={"/theSocialNetwork/theSocialNetwork_voice.mp3"} />
//                 <audio id="music" ref={musicRef} src={"/theSocialNetwork/theSocialNetwork_music.mp3"} />
//                 <audio id="other" ref={otherRef} src={"/theSocialNetwork/theSocialNetwork_other.mp3"} />
//                 {isFullScreen && (
...
//             <div>
//                 <button className="py-2 px-4 m-1 border-solid border-2 rounded-md border-gray-500" onClick={() => { handleCaptions() }}>{captions ? "Turn OFF captions ❌" : "Turn ON captions ©©"}</button>
//                 {captions ? <button className="py-2 px-4 m-1 border-solid border-2 rounded-md border-gray-500" onClick={() => handleSimpleCaptions()}>{simpleCaptions ? "Return Default" : "Make Simple"}</button> : <></>}
//             </div>
